...
select name,quantity,price,bookdescr from cart where email='<%=session.getAttribute("email").toString() %>' and paidstatus='1';
</sql:query>
<div class="firstcart">
<table >
<tr>
...
<td><input type="button" value="shipped" style="border: none;">
</tr>
</c:forEach>
</table>
</div>
